...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		GameSound.load("/SFX/playerjump.mp3", "playerjump");
		GameSound.load("/SFX/playerlands.mp3", "playerlands");
		GameSound.load("/SFX/playerattack.mp3", "playerattack");
		GameSound.load("/SFX/playerhit.mp3", "playerhit");
		GameSound.load("/SFX/playercharge.mp3", "playercharge");
