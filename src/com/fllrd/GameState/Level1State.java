...
public class Level1State extends GameState {
	...
	public void init() {
		...
		// music
		GameSound.load("/Music/level1.mp3", "level1");
		GameSound.loop("level1", 600, GameSound.getFrames("level1") - 2200);
	...
	private void populateEnemies() {
		...
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(1320, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(1340, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(1660, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(1680, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(1700, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(2177, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(2960, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
		Sli.setPosition(2980, 100);
		enemies.add(Sli);
		Sli = new Slime(tileMap, player);
