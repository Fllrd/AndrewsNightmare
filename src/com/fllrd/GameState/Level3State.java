...
import com.fllrd.Entity.Portal;
import com.fllrd.Entity.Spirit;
import com.fllrd.Entity.Artfact.BottomLeftPiece;
import com.fllrd.Entity.Artfact.BottomRightPiece;
import com.fllrd.Entity.Artfact.TopLeftPiece;
import com.fllrd.Entity.Artfact.TopRightPiece;
import com.fllrd.Entity.Enemies.DarkEnergy;
...
public class Level3State extends GameState {
    ...
    public void init() {
        ...
        // music
        GameSound.load("/Music/level1boss.mp3", "level1boss");
        GameSound.load("/Music/fanfare.mp3", "fanfare");
...
///////////////////////////////////////////////////////
    ...
    private void eventFinish() {
        ...
        if (eventCount == 60) {
            ...
            gsm.setState(GameStateManager.CompleteState);
        }
    ...
    private void eventPortal() {
        ...
        if (eventCount == 362) {
            ...
            GameSound.loop(
                    ...
                    0,
                    60000,
                    GameSound.getFrames("level1boss") - 4000
            );
        }
        if (eventCount == 420) {
