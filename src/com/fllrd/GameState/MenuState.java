...
public class MenuState extends GameState {
    ...
    public MenuState(GameStateManager gsm) {
        ...
        try {
            ...
            // load sound fx
            GameSound.load("/SFX/menuoption.mp3", "menuoption");
            GameSound.load("/SFX/menuselect.mp3", "menuselect");
    ...
    public void draw(Graphics2D g) {
        ...
        g.setFont(titleFont);
        g.drawString("Andrew's Nightmare", 70, 90);
    ...
    private void select() {
        if (currentChoice == 0) {
            GameSound.play("menuselect");
            PlayerSave.init();
            gsm.setState(GameStateManager.Level1State);    // CHANGE STARTING LEVEL
